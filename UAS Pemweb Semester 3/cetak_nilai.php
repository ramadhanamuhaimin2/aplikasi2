...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="border-style: solid;">
        <h1 class="mt-4">Nilai Mahasiswa UNS</h1>
        <hr>
        <br>
        <div class="row">
        ...
        <div class="row">
            <div class="col-3"><p>Kode Mata Kuliah - Nama Mata Kuliah</p></div>
            <div class="col-9">: <?php echo $KodeMK_NamaMK;?></div>
        </div>
        <div class="row">
            <div class="col-3"><p>NILAI</p></div>
            <div class="col-9">: <?php echo $Nilai;?></div>
        </div>
        <div class="row">
